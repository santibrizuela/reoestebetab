...
import BannerBrand from '@/public/reoeste/logoREO.png';
...
const Carousel = () => {
    return ( 
        <div className="h-[30rem] bg-cover bg-center md:bg-fixed">
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div 
                    className='justify-center text-center'
                >
                    <Image 
                        className='group-hover:scale-125 transition-all duration-500 w-72 m-auto' 
                        src={BannerBrand} 
                    ...
                    <div className="my-2">
                        <Link href='/planesdeahorro'>
                            <div className='btn btn-primary m-1'>
                                <p className='p-2'>Servicio Técnico</p>
                            </div>
                        </Link>
                        <Link target='_blank' rel='noreferrer' href='https://wa.me/5491122502345?text=Hola!%20Necesito%20m%C3%A1s%20informaci%C3%B3n%20sobre%20un%20veh%C3%ADculo%20publicado%20en%20la%20web.'>
                            <div className='btn btn-primary btn-outline m-1'>
                                <p className='p-2'>Repuestos</p>
                            </div>
                        </Link>
                    </div>
                    

                    <div className='flex items-center justify-center max-w-[330px] m-auto text-2xl gap-3'>
